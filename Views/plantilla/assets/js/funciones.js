$(function () {
    ...
    /* Aceptar cita funcion del doctor */

    $("#table").on("click", ".btnAceptarCita", function () {
        Swal.fire({
            title: 'Aceptar Solicitud?',
            text: "Aceptaras la solicitud de cita!",
            icon: 'question',
            ...
            if (result.isConfirmed) {
                ...
                var datos = JSON.parse($(this).attr('data-cita'));
                console.log(datos);
                ...
                $.ajax({
                    url: 'confirmacion/aceptarCita',
                    type: "POST",
                    data: { "idD": id_doctor, "idP": idPaciente, "idC": idCita },
                    success: function (respuesta) {
                        $("#table").DataTable().destroy();
                        $("#table tbody").html(respuesta);
                        inicializarDataTable();
