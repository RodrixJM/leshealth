        ...
        for ($i = 0; $i < count($fila); $i++) {
         ...
         <td> <a href="' . PLANTILLA . 'assets/img/' .$fila[$i]['imagen']. '" data-fancybox="gallery" data-caption="'.$fila[$i]['motivo'].'">
          ...
          <td>
             ...
             <button style="background-color: #5A2A7A	; border: #5A2A7A	;" data-Consulta=\'' . $datos . '\' " class="btn btn-info btn-circle btnAgregarConsulta" data-bs-toggle="modal"
   ...
   <i class="fas fa-xmark"> </i>
       ...
       public function index()
    {
     ...
     public function aceptarCita(){
           ...
           $this->_paciente->agendarCita($this->getTexto('idD'),$this->getTexto('idP'),$this->getTexto('idC'));
